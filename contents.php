            ...
            if($fileError === 0 ){
                ...
                if ($fileSize < 800000000 ){
                    ...
                    if(move_uploaded_file($fileTmpName,$fileDestination)){
                    	...
                    	$ins = "INSERT INTO article(title, filename, class) VALUES('$title', '$filename', '$class')";
                    	$quer = mysqli_query($mysqli,$ins);
                    	if ($quer !== false) {
                    		echo '<script>swal({
                                    title: "Article Uploaded Sucessfully!",
                                    icon: "success",
                                    buttons: true,
                                  }).then(function(ok) {
                                    if (ok) {
...
<main style="margin-left: 300px;margin-top: 30px;">
  ...
  <select class="browser-default" name="class" required>
    ...
    <option value="SS 3">SS 3</option>
     ...
     <div class="file-field input-field" style="margin-top: 50px;margin-bottom:" required>
